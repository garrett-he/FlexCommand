...
FC_ExecuteCommand = FlexCommand.command.ExecuteCommand

-- FlexCommand.event module
FC_RegisterEvent = FlexCommand.event.RegisterEvent
FC_RaiseEvent = FlexCommand.event.RaiseEvent
